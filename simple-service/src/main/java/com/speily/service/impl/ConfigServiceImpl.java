...
import com.speily.mapper.ConfigMapper;
...
public class ConfigServiceImpl implements IConfigService {
    ...
    public int insertConfig(Config config) {
        config.setCreateBy(CurrentUserUtils.getSysUser().getLoginName());
    ...
    public int updateConfig(Config config) {
        config.setUpdateBy(CurrentUserUtils.getSysUser().getLoginName());
