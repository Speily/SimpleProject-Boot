...
import com.speily.entity.DictType;
import com.speily.common.result.Ztree;
import com.speily.mapper.DictDataMapper;
import com.speily.mapper.DictTypeMapper;
import com.speily.service.IDictTypeService;
...
public class DictTypeServiceImpl implements IDictTypeService {
    ...
    public int insertDictType(DictType dictType) {
        dictType.setCreateBy(CurrentUserUtils.getSysUser().getLoginName());
    ...
    public int updateDictType(DictType dictType) {
        dictType.setUpdateBy(CurrentUserUtils.getSysUser().getLoginName());
